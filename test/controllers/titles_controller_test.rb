...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { author_id: @title.author_id, genre: @title.genre, published_year: @title.published_year } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { author_id: @title.author_id, genre: @title.genre, published_year: @title.published_year } }
